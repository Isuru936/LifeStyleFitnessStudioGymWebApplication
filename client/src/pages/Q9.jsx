...
import wmodel from "../assets/Sit.png";
    ...
    <div className="bg-zinc-900 w-full h-full flex justify-center p-20 px-5 py-40">
      ...
      <div className="bg-black bg-opacity-40 rounded-[20px] border border-stone-800 backdrop-blur-sm justify-center p-6 shadow-lg backdrop filter relative">
        <div className="py-2 px-4">
          <h1 className="text-center static text-white text-xl mb-8 font-['Josefin Slab']">Do you smoke?</h1>
          <div className="mb-[40px] p-2" >
           <div className="bg-slate-500 rounded-[15px] h-9 mb-2 flex justify-center">
              ...
              <label className="ml-[70px]" htmlFor=""></label>
              <input className="align-middle cursor-pointer" type="radio" id="smoke_Yes" name="Smoke" />
            </div>
            <div className="bg-slate-500 rounded-[15px] h-9 mb-2 flex justify-center">
              <label className="text-rose-500 text-[1.25rem] font-bold " htmlFor="radioOption1">No</label>
              <label className="ml-[70px]" htmlFor=""></label>
              <input className="align-middle cursor-pointer" type="radio" id="smoke_No" name="Smoke" />
            </div>
            </div>
