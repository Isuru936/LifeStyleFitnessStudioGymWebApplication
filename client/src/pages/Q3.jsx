...
import wmodel from "../assets/model.jpg";
          ...
          <div className="flex justify-center">
            <form action="">
              <div className="flex justify-center mt-10 mb-14">
                <button onClick={changeMeasurement} type="Radio" name="Ft" className={`opacity-${isSelected ? '100' : '30'}`}>
                  <label className="px-10 py-10 bg-amber-600 rounded-bl-[10px] rounded-tl-[10px]" htmlFor="Ft">
                    Ft
                  </label>
                </button>
                <button onClick={changeMeasurement2} type="Radio" name="cm" className={`opacity-${isSelected2 ? '100' : '30'}`}>
