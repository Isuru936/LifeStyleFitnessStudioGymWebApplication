          ...
          <div className="flex flex-col ">
            <div className=" m-32 lg:m-5 w-fit border-2 pt-8 pb-8 pr-5 pl-5 bg-gray-50 h-full rounded-xl">
              <div className="text-black">
                <h1 className="font-bold text-4xl lg:text-5xl">Add a new exercise/workout</h1>
              </div>
                  ...
                  <form action="" className="mt-5 text-base lg:text-xl">
                    <div className="mb-4 lg:mb-6">
                      ...
                      <input
                        ...
                        className="outline-none border-2 border-gray-100 rounded-lg p-1 lg:p-2 w-full lg:w-auto mt-2 text-sm lg:text-base"
                      />
                    </div>
                    <div className="mb-4 lg:mb-6">
