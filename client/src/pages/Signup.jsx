     ...
     <div className="bg-white">
            ...
            <div className=" bg-white bg-opacity-40 rounded-[20px] border border-stone-800 backdrop-blur-sm justify-center p-6 shadow-lg backdrop filter relative lg:10">
                ...
                <form action="">
                    ...
                    <div className="mb-3">
                        <input className="rounded-[10px] bg-gray-500 opacity-65" type="username" id="username" />
                    </div>
                    <div className="h-5 text-black text-sm font-normal font-['Inria Sans'] mb-2 ">
                    ...
                    <div className="mb-3"> 
                        <span className="flex justify-center size- text-blue-900">Have an account already?</span>
                    </div>
                    <div className="flex justify-center mb-3">
                    <button className=" w-[108px] h-[35px] bg-amber-600 rounded-[10px]" type="submit">Signup</button>
                    </div>
